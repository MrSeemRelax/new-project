...
## Enjoy!! 😸
"# nouveau-projet"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/MrSeemRelax/nouveau-projet.git git push -u origin master
"# nouveau-projet" 
